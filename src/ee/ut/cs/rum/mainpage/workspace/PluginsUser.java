...
public class PluginsUser extends Panel implements View {
	public static final String NAME = "pluginsUser";
	...
	public PluginsUser() {
		...
		Label aboutText = new Label("Imagine a magnificent view of plugins that the user can use...");
	...
	private void createEnterButton(String label) {
		...
		enterButton.addClickListener(new Button.ClickListener() {
		    public void buttonClick(ClickEvent event) {
		    	currentUI.getRumNavigator().navigateTo(PluginsUser.NAME);
		    }
		});
	}
	...
	public void enter(ViewChangeEvent event) {
		...
		currentUI.getSideBar().setCurrentView(PluginsUser.NAME);
	}
}
