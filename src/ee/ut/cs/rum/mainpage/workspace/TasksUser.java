...
public class TasksUser extends Panel implements View {
	public static final String NAME = "tasksUser";
	...
	public TasksUser() {
		...
		Label aboutText = new Label("Imagine a magnificent Task monitor...");
	...
	private void createEnterButton(String label) {
		...
		enterButton.addClickListener(new Button.ClickListener() {
		    public void buttonClick(ClickEvent event) {
		    	currentUI.getRumNavigator().navigateTo(TasksUser.NAME);
		    }
		});
	}
	...
	public void enter(ViewChangeEvent event) {
		...
		currentUI.getSideBar().setCurrentView(TasksUser.NAME);
	}
