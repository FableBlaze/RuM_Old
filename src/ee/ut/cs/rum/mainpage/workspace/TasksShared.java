...
public class TasksShared extends Panel implements View {
	public static final String NAME = "tasksShared";
	...
	public TasksShared() {
		...
		Label aboutText = new Label("Imagine a magnificent view of shared tasks... Like a Facebook front page of coolness");
		aboutText.setSizeUndefined();
		this.setContent(aboutText);
		
		createEnterButton("Shared tasks");
	}
	...
	private void createEnterButton(String label) {
		...
		enterButton.addClickListener(new Button.ClickListener() {
		    public void buttonClick(ClickEvent event) {
		    	currentUI.getRumNavigator().navigateTo(TasksShared.NAME);
		    }
		});
	}
	...
	public void enter(ViewChangeEvent event) {
		...
		currentUI.getSideBar().setCurrentView(TasksShared.NAME);
	}
}
